...
// Color theme map (unchanged from GitHub version)
const colorMap = {
...
// Format backend date → "Apr 28, 2026"
    ...
    useEffect(() => {
        async function load() {
            try {
                ...
                // Convert backend fields → GitHub UI fields
                const mapped = data.map(n => ({
                    id: n.id,
                    title: n.title,
                    body: n.content,          // GitHub UI expects "body"
