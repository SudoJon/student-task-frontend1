...
export default function NewNote() {
  ...
  function handleSave() {
    ...
    localStorage.setItem("bucketlyst_notes", JSON.stringify([newNote, ...existing]));
    setSaved(true);
  ...
  return (
    <div style={{ fontFamily: "'Inter',-apple-system,sans-serif", paddingBottom: 40 }}>
      ...
      <div style={{
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
          <div style={{
            ...
            fontSize: 24, boxShadow: `0 6px 18px ${activeColor.dot}44`,
        ...
        <div style={{ display: "flex", gap: 10 }}>
          ...
          <button
            ...
            style={{
              ...
              fontFamily: "inherit",
              boxShadow: hasContent ? "0 4px 14px rgba(124,58,237,0.28)" : "none",
      ...
      <div style={{
            ...
            {NOTE_COLORS.map(c => (
              <button
                ...
                style={{
                  ...
                  background: c.dot, border: "none",
                  outline: color === c.key ? `3px solid ${c.dot}` : "3px solid transparent",
                  outlineOffset: 2, cursor: "pointer",
                  transform: color === c.key ? "scale(1.25)" : "scale(1)",
                  transition: "transform 0.15s, outline 0.15s",
                  boxShadow: color === c.key ? `0 0 0 4px ${c.bg}` : "none",
                }}
              />
            ))}
          </div>
          <span style={{
            fontSize: 12, color: activeColor.dot, fontWeight: 700,
            background: activeColor.bg, padding: "2px 10px",
            borderRadius: 999, border: `1px solid ${activeColor.border}`,
          }}>
            {activeColor.label}
          </span>
        </div>
        ...
        <input
          ...
          style={{
            ...
            border: "none", borderBottom: `2px solid ${activeColor.border}`,
          ...
          onFocus={e => e.target.style.borderBottomColor = activeColor.dot}
          onBlur={e  => e.target.style.borderBottomColor = activeColor.border}
        />
      ...
      <div style={{ display: "flex", gap: 12, marginTop: 20, flexWrap: "wrap" }}>
        {[
          { icon: "💡", tip: "Notes are saved locally in your browser." },
